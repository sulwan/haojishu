...
(100, 0, '0', '好技术科技', 0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00'),
...
(1, '系统默认（无参）', 'DEFAULT', 'hjsTask.hjsNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11:33:00', 'admin', '2020-04-20 15:59:24', ''),
(2, '系统默认（有参）', 'DEFAULT', 'hjsTask.hjsParams(\'ry\')', '0/15 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', ''),
(3, '系统默认（多参）', 'DEFAULT', 'hjsTask.hjsMultipleParams(\'ry\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '');
...
(1, '系统默认（无参）', 'DEFAULT', 'ryTask.ryNoParams', '系统默认（无参） 总共耗时：4毫秒', '1', 'org.springframework.beans.factory.NoSuchBeanDefinitionException: No bean named \'ryTask\' available\r\n	at org.springframework.beans.factory.support.DefaultListableBeanFactory.getBeanDefinition(DefaultListableBeanFactory.java:808)\r\n	at org.springframework.beans.factory.support.AbstractBeanFactory.getMergedLocalBeanDefinition(AbstractBeanFactory.java:1279)\r\n	at org.springframework.beans.factory.support.AbstractBeanFactory.doGetBean(AbstractBeanFactory.java:297)\r\n	at org.springframework.beans.factory.support.AbstractBeanFactory.getBean(AbstractBeanFactory.java:202)\r\n	at com.haojishu.utils.spring.SpringUtils.getBean(SpringUtils.java:38)\r\n	at com.haojishu.utils.JobInvokeUtil.invokeMethod(JobInvokeUtil.java:32)\r\n	at com.haojishu.utils.QuartzDisallowConcurrentExecution.doExecute(QuartzDisallowConcurrentExecution.java:19)\r\n	at com.haojishu.utils.AbstractQuartzJob.execute(AbstractQuartzJob.java:42)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:202)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:573)\r\n', '2020-04-20 15:47:33'),
(2, '系统默认（无参）', 'DEFAULT', 'hjsTask.hjsNoParams', '系统默认（无参） 总共耗时：2毫秒', '0', '', '2020-04-20 15:58:38'),
(3, '系统默认（无参）', 'DEFAULT', 'hjsTask.hjsNoParams', '系统默认（无参） 总共耗时：0毫秒', '0', '', '2020-04-20 15:59:00'),
(4, '系统默认（无参）', 'DEFAULT', 'hjsTask.hjsNoParams', '系统默认（无参） 总共耗时：0毫秒', '0', '', '2020-04-20 15:59:10'),
(5, '系统默认（无参）', 'DEFAULT', 'hjsTask.hjsNoParams', '系统默认（无参） 总共耗时：1毫秒', '0', '', '2020-04-20 15:59:20');
...
(1, '系统管理', 0, 1, '#', 'menuItem', 'M', '0', '', 'fa fa-gear', 'admin', '2018-03-16 11:33:00', 'admin', '2020-04-18 18:02:55', '系统管理目录'),
...
(1, '管理员', 'admin', 1, '1', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2020-04-18 22:54:36', '管理员');
...
(1, 103, 'admin', '好技术开发工程师', '00', 'sulwan@126.com', '15888888888', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-04-20 10:49:20', 'admin', '2018-03-16 11:33:00', 'ry', '2020-04-20 10:49:19', '管理员');
...
--
ALTER TABLE `sys_job_log`
  MODIFY `job_log_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '任务日志ID', AUTO_INCREMENT=6;

--
-- 使用表AUTO_INCREMENT `sys_logininfor`
--
ALTER TABLE `sys_logininfor`
  MODIFY `info_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '访问ID', AUTO_INCREMENT=100;

--
-- 使用表AUTO_INCREMENT `sys_menu`
--
ALTER TABLE `sys_menu`
  MODIFY `menu_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '菜单ID', AUTO_INCREMENT=2000;

--
-- 使用表AUTO_INCREMENT `sys_notice`
--
ALTER TABLE `sys_notice`
  MODIFY `notice_id` int(4) NOT NULL AUTO_INCREMENT COMMENT '公告ID', AUTO_INCREMENT=11;

--
-- 使用表AUTO_INCREMENT `sys_oper_log`
--
ALTER TABLE `sys_oper_log`
  MODIFY `oper_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '日志主键', AUTO_INCREMENT=100;
...
--
ALTER TABLE `sys_user`
  MODIFY `user_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '用户ID', AUTO_INCREMENT=100;
