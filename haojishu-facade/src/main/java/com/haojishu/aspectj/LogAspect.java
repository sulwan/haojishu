...
import com.haojishu.domain.SysOperLog;
import com.haojishu.domain.SysUser;
import com.haojishu.enums.BusinessStatus;
import com.haojishu.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.haojishu.annotation.Log)")
