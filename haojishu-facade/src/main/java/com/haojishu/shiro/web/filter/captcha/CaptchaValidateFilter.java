package com.haojishu.shiro.web.filter.captcha;
...
public class CaptchaValidateFilter extends AccessControlFilter {
  ...
  protected boolean isAccessAllowed(
    ...
    return validateResponse(
        httpServletRequest, httpServletRequest.getParameter(ShiroConstants.CURRENT_VALIDATECODE));
  }
  ...
  public boolean validateResponse(HttpServletRequest request, String validateCode) {
    ...
    redisUtils.set(request.getParameter("username") + ShiroConstants.CURRENT_CAPTCHA, code);
    return true;
  }
